...
void readESP32(AsyncWebServer* server, ParamsStruct* params) {
    ...
    */
    ...
    while (1)
    {
        ...
        // convert all double values to raw strings in order to send via. XHR
      ...
      // TODO: Find how to send the ArmJointStruct (contains joint angles)
      //    Need to decide on where in the program to read potentiometer values on the ESP32
      //    Should we have that code here or main.cpp?
      //    Probably simpler to have that code here. Review with Colin on code standards. 
